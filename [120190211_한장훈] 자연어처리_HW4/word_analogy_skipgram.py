from train_skipgram import SkipGram
from train_skipgram import word_to_ix
from train_skipgram import WINDOW_SIZE,EMBEDDING_DIM
import torch
import torch.nn.functional as F

model = SkipGram(len(word_to_ix), EMBEDDING_DIM, WINDOW_SIZE)
model.load_state_dict(torch.load( 'skip_gram.epoch9.model'))
wordvec = [0, 0, 0, 0]
tmp = 0
correct = 0
cnt = 0
